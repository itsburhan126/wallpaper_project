...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Edit Game</h1>
            <p class="text-sm text-slate-500 mt-1">Update game details and rewards</p>
        </div>
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" name="title" id="title" required value="{{ old('title', $game->title) }}"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="url" id="url" required value="{{ old('url', $game->url) }}"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="play_time" id="play_time" required min="1" value="{{ old('play_time', $game->play_time) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all text-sm">
                        </div>
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="win_reward" id="win_reward" required min="0" value="{{ old('win_reward', $game->win_reward) }}"
                                class="w-full pl-10 pr-4 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all text-sm">
                        </div>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="w-full px-4 py-2.5 rounded-lg bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all text-sm resize-none" placeholder="Enter game description...">{{ old('description', $game->description) }}</textarea>
                    </div>

                    <!-- Image Upload -->
                    <div class="col-span-2">
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Game Image</label>
                        <div class="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-indigo-500 hover:bg-indigo-50/50 transition-all cursor-pointer relative group" id="drop-zone">
                            <input type="file" name="image" id="image" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" accept="image/*" onchange="previewImage(event)">
                            <div id="upload-prompt" class="group-hover:scale-105 transition-transform duration-300 {{ $game->image ? 'hidden' : '' }}">
                            ...
                            <div id="image-preview" class="{{ $game->image ? '' : 'hidden' }} h-48 flex items-center justify-center relative z-20 pointer-events-none">
                                <img src="{{ $game->image ? asset($game->image) : '' }}" class="max-h-full rounded-lg shadow-sm object-contain">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2 flex flex-col sm:flex-row gap-6 p-4 bg-slate-50 rounded-lg border border-slate-100">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ $game->is_active ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ $game->is_featured ? 'checked' : '' }}
